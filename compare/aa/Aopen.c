...
SHORT * s_rena = 0 ;
int f_rena = 0 ;
A_OBJECT A_add ( A, a, b, c ) A_OBJECT A ;
int a, b, c ;
{
  A_row * p ;
...
A_OBJECT A_rename ( A, rena ) A_OBJECT A ;
SHORT * rena ;
{
  A_row * p, * pz ;
  SHORT * trena, * sp ;
...
A_OBJECT A_mkdense ( A ) A_OBJECT A ;
{
  A_row * p, * pz ;
  R_OBJECT R ;
