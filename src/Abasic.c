...
void A_conform( register A_OBJECT A1, register A_OBJECT A2 ) {
    register int i;
    register A_row *p;
...
A_OBJECT A_letter( int t, int x ) {
    ...
    return(
        A_add(
            A_add( A, START, x * A-> A_nT + t, 2 ),
            2, 1, FINAL ) ); }

A_OBJECT A_deecho( register A_OBJECT A, int ECHO, int NOECHO ) {
...
A_OBJECT A_opt( register A_OBJECT A ) {
...
A_OBJECT A_plus( register A_OBJECT A ) {
    register int new_state;
    register A_row *p;
...
A_OBJECT A_union( register A_OBJECT A1, register A_OBJECT A2 ) {
    ...
    A1 = A_add(
             A_add( A1, START, 0, base ),
             START, 0, base + 1 );
    A_destroy( A2 );
    return( A1 ); }

A_OBJECT A_percent( register A_OBJECT A1, register A_OBJECT A2 ) {
...
A_OBJECT A_concat( register A_OBJECT A1, register A_OBJECT A2 ) {
    register int base, a, c;
    register A_row *p;
...
A_OBJECT A_intersect( register A_OBJECT A1, register A_OBJECT A2 ) {
    register A_OBJECT A;
    int current;
    A_row *p1, *p1z, *p2, *p2z;
    R_OBJECT R;
...
A_OBJECT A_differ( register A_OBJECT A1, register A_OBJECT A2 ) {
    register A_OBJECT A;
    int current, dead;
    A_row *p1, *p1z, *p2, *p2z;
    R_OBJECT R;
...
A_OBJECT A_xor( register A_OBJECT A1, register A_OBJECT A2 ) {
    register A_OBJECT A;
    int current, dead;
    A_row *p1, *p1z, *p2, *p2z;
    R_OBJECT R;
...
A_OBJECT A_alph( register A_OBJECT A ) {
    register A_row *p;
...
A_OBJECT A_rev( register A_OBJECT A ) {
    register A_row *p;
    register int tmp;
    int new_state;
    int old_mode;
...
A_OBJECT A_shuffle( register A_OBJECT A1, register A_OBJECT A2 ) {
    register A_OBJECT A;
