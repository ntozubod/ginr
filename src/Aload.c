...
void put_name( register char *str )
{
    register int i;
...
A_OBJECT A_store( register A_OBJECT A,
                  char *file, register T_OBJECT T_Sigma )
{
    register int t;
    register A_row *p, *pz;
...
A_OBJECT A_save( register A_OBJECT A, char *file, register T_OBJECT T_Sigma )
{
    register int t;
    register A_row *p, *pz;
...
A_OBJECT A_prsseq( register A_OBJECT A,
                   char *file, register T_OBJECT T_Sigma )
{
    register int t;
    register A_row *p, *pz;
